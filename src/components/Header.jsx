  ...
  return (
    <header className="flex items-center justify-beetween xl:justify-start w-full py-4 px-8 h-[15vh] z-50">
      <div className="xk:w-1/4  text-center -mt-4">
        <a href="#" className="flex text-2xl font-bold relative p-4 text-grays ">
        Your spiritual help <span className="text-primary  text-4xl">.</span>{" "}
          <RiBlazeFill className="text-5xl absolute -left-3 -bottom-5 text-primary -z-10" />
        </a>
      </div>
      <nav
      ...
      <button onClick={() => setShowMenu(!showMenu)} className="xl:hidden text-3xl p-14 text-grays ">
